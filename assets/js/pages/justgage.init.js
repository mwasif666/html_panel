...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  document
    .getElementById("Counter_2_refresh")
  ...
  document
    .getElementById("Counter_refresh")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("Animation_Events_refresh")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("Custom_wether_refresh")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("font_option_refresh")
    .addEventListener("click", function () {
